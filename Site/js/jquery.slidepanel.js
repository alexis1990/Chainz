;(function ( $, window, document, undefined ) {
    ...
    Slidepanel.prototype.init = function () {
        ...
        if($('#slidepanel').length == 0){
            var panel_html = '<div id="slidepanel" class="cb_slide_panel"><div class="wrapper"><a href="#" class="close button">Close</a><div class="inner "><div class="wrapper"><h3>Woohoo! Alright!</h3></div></div></div></div>';
            $(panel_html).hide().appendTo($('.desktop-box'));    
        }
